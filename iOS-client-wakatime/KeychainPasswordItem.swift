...
struct KeychainPasswordItem {
    ...
    func savePassword(_ password: String) throws {
        ...
        do {
            ...
            let query = KeychainPasswordItem.keychainQuery(withService: service, accessGroup: accessGroup)
            ...
            */
            var newItem = KeychainPasswordItem.keychainQuery(withService: service, accessGroup: accessGroup)
